...
public class Tc044  extends TestLogin {
	...
	public void vadlidateClientPage() throws InterruptedException, IOException {
		...
		Thread.sleep(10000);
		driver.findElement(By.xpath(PropertyManager.getProperty("filterBtn"))).click();
		Thread.sleep(4000);
		driver.findElement(By.xpath(PropertyManager.getProperty("StakeholdercategoryBtn"))).click();
		Thread.sleep(4000);
		driver.findElement(By.xpath(PropertyManager.getProperty("ManagementBtn"))).click();
