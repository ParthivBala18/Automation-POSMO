...
public class AddValidExternal extends TestLogin {
	...
	@Test(priority =2)
	public void addValidext() throws InterruptedException, IOException {
		WebDriverWait wait=new WebDriverWait(driver, 15);
		...
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
		enterContactno.sendKeys("1234567891018");
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
		...
		enteremail.sendKeys("sample2585@email.com");
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
		...
		entercompany.click();
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
		entercompany.sendKeys("Sample25");
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
		...
		enterstate.click();
		driver.manage().timeouts().pageLoadTimeout(500000, TimeUnit.MILLISECONDS);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(PropertyManager.getProperty("ClickState")))).click();
		driver.manage().timeouts().pageLoadTimeout(500000, TimeUnit.MILLISECONDS);

		/*
	WebElement entercity =wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(PropertyManager.getProperty("EnterCity"))));
	driver.manage().timeouts().pageLoadTimeout(50000, TimeUnit.MILLISECONDS);
	entercity.click();
	driver.manage().timeouts().pageLoadTimeout(50000, TimeUnit.MILLISECONDS);
	WebElement clickcity =wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(PropertyManager.getProperty("ClickCity"))));
	driver.manage().timeouts().pageLoadTimeout(50000, TimeUnit.MILLISECONDS);
	clickcity.click();
	driver.manage().timeouts().pageLoadTimeout(50000, TimeUnit.MILLISECONDS);
		 */

		WebElement enterzipcode=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(PropertyManager.getProperty("EnterZipcode"))));
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
		enterzipcode.click();
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
		enterzipcode.sendKeys("5555515");
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
