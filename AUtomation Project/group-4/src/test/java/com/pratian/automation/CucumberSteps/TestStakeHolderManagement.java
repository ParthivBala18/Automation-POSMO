...
public class TestStakeHolderManagement {
	...
	public void user_selects_management_sort() {
		...
		cobj.clickManagementButtton();
		System.out.println("MANAGEMENT CLICK SUCCESS");
