...
public class AddValidInternal extends TestLogin {
	...
	public void addValidInt() throws InterruptedException, IOException {
		...
		enterName.click();
		enterName.sendKeys("Samplessexzxzx");
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
		...
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
		enterContactno.sendKeys("123458907946");
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
		...
		enteremail.sendKeys("samples2020@gmail.com");
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
