...
public class Tc041 extends TestLogin {
	@Test(priority = 1)
	public void vadlidateClientPage() throws InterruptedException, IOException {
		...
		Thread.sleep(10000);
		driver.findElement(By.xpath(PropertyManager.getProperty("StakeholdertypeBtn"))).click();
		Thread.sleep(10000);
		driver.findElement(By.xpath(PropertyManager.getProperty("InternalBtn"))).click();
		Thread.sleep(10000);
	}
}