...
public class Tc060 extends TestLogin{
	...
	@Test(priority = 2)
	public void filterStakeholderInvestor() throws IOException {
		...
		driver.manage().timeouts().pageLoadTimeout(10000, TimeUnit.MILLISECONDS);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(PropertyManager.getProperty("investorid")))).click();
